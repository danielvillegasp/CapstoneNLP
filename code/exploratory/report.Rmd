...
HCCcorpus <- read.HCC(base.path = '../../data/LOCALE/', category=c('twitter', 'news', 'blogs'), n.lines = 25000)
...
### Document Summary
The number of lines per document i.e. tweets, news and blogs. was limited to 25000. Here, a 
